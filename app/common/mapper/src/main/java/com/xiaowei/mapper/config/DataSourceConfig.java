package com.xiaowei.mapper.config;
...
public class DataSourceConfig {
     ...
     */
    private static String MAPPER_PATH = "/com/xiaowei/mapper/**/*.xml";
    private static String TYPE_ALIASES_Package = "com.xiaowei.mapper.dataobject";
    static final String PACKAGE = "com.xiaowei.mapper.mapper";
    @Autowired
